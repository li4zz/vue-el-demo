...
var routes = [
  ...
  {path: '/css-demo', component: ()=> import(/* webpackChunkName: "css-demo" */ "@/views/css-demo.vue") ,name: "css小demo " },
  ...
  {path: '/vue-snow', component: ()=> import(/* webpackChunkName: "vue-snow" */ "@/views/vue-snow.vue") ,name: "纯css雪花动画 " },
