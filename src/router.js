...
var routes = [
  ...
  {path: '/slice-upload', component: ()=> import(/* webpackChunkName: "slice-upload" */ "@/views/slice-upload.vue")  },
  ...
  {path: '/vue-countupjs', component: ()=> import(/* webpackChunkName: "vue-countupjs" */ "@/views/vue-countupjs.vue")  },
  {path: '/vue-href', component: ()=> import(/* webpackChunkName: "vue-href" */ "@/views/vue-href.vue")  },
  {path: '/vue-overflow', component: ()=> import(/* webpackChunkName: "vue-overflow" */ "@/views/vue-overflow.vue")  },
  {path: '/vue-scroll', component: ()=> import(/* webpackChunkName: "vue-scroll" */ "@/views/vue-scroll.vue")  },
  {path: '/vue-tree-demo', component: ()=> import(/* webpackChunkName: "vue-tree-demo" */ "@/views/vue-tree-demo.vue")  },
  {path: '/vue-tree', component: ()=> import(/* webpackChunkName: "vue-tree" */ "@/views/vue-tree.vue")  },
  {path: '/vxe-table', component: ()=> import(/* webpackChunkName: "vxe-table" */ "@/views/vxe-table.vue")  },
  {path: '/wang-editor', component: ()=> import(/* webpackChunkName: "wang-editor" */ "@/views/wang-editor.vue")  },
