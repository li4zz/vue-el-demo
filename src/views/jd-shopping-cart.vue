      ...
      <div class="item" v-for="item in 10" :key="item">
        <div class="product-card">
          ...
          <div class="product-image">
            <!-- <img src="@/assets/images/jd/4.jpg" /> -->
            <!-- <img :src="'@/assets/images/jd/' + item + '.jpg'" /> -->
            <img
              :src="require(`@/assets/images/jd/${item}.jpg`)"
              alt="动态图片"
            />
          </div>
          <div class="product-info">
            <div class="product-title">
              大疆 DJI Osmo Pocket {{ item }} 一英寸口袋云台相机
            </div>
...
export default {
  ...
  methods: {
    ...
    startRolling(event) {
      // 获取起点和终点元素
      const startPoint = event.currentTarget;
    ...
    getBallStyle(ball) {
      ...
      // 二次贝塞尔曲线公式
      const x =
        mt * mt * ball.startX + 2 * mt * t * controlX + t * t * ball.endX;
      const y =
        mt * mt * ball.startY + 2 * mt * t * controlY + t * t * ball.endY;
